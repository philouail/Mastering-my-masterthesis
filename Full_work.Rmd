...
package_list <- c("patchwork", "Seurat", "tidyverse","scales", "umap",
                  "data.table", "scCustomize", "celldex", "SingleR", "viridis","ggplot2" ,"ggpubr" )
...
And dotplots were ran and generated dot plots for each. Here an examples for mCAFs: 
...
```{r}
light.seurat <- readRDS("light.seurat.rds")
...
MasterList <- merge( MasterList[,-c(2,3,4, 5)],Antibodies1 %>% distinct(Gene, .keep_all=TRUE), by = "Gene")
